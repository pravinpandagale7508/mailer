...
//
//
//    @Before("execution(* com.utcl.ccnfservice.controller.master.*.* (..))")
...
//    }
//
//    @AfterReturning(pointcut = "execution(* com.utcl.ccnfservice.controller.master.*.* (..))", returning = "result")
...
//    }
//    @AfterThrowing(pointcut = "execution(* com.utcl.ccnfservice.controller.master.*.* (..))", throwing = "ex")
