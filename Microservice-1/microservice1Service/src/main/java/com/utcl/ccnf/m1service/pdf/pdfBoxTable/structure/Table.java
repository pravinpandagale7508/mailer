...
import com.utcl.ccnf.m1service.pdf.pdfBoxTable.settings.*;
...
public class Table { 
    ...
    public static class TableBuilder {
        ...
        public TableBuilder addColumnsOfWidthFromArr(final float[] columnWidths) {
        	PDRectangle p =PDRectangle.A4;
        	
            for (float columnWidth : columnWidths) {
            	float x = ((p.getWidth()-20)*columnWidth)/100;
                addColumnOfWidth(x);
            }
            return this;
        }
